 ...
 * @Description: 使用jdk序列化的方式将十万个user对象保存到redis，
 *                测试所耗时间
 *                
...
public class RedisJdkTest {
	...
	@Resource
	private RedisTemplate<String,User>  redisTemplate;//或者<String,Serializable>
    ...
    public void test_jdk() {
       ...
       System.out.println("采用jdk序列化存储的时间:"+(end-start));
       //采用jdk序列化存储的时间:24015(时间不是固定的)
    }
